export const cards = [
  ...
  },
  {
    ...
    upperCost: "1",
    upperActionText:
      "Place a BEACON token in any Space on the board. During your next Passive Turn, teleport the Destiny Tian to the SPace with the BEACON token (it can Push). Remove the BEACON token.",
    lowerCost: "0",
    costType: "charge",
    lowerAction: "REACTOR",
    lowerActionText:

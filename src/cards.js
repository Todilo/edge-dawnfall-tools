export const cards = [
  ...
  },
  {
    ...
    upperCost: "1",
    upperActionText: "Teleport 1 Demon model (it can Push).",
    lowerCost: "2",
    costType: "crystal",
    lowerAction: "FREEZE",
    lowerActionText:
  ...
  },
  {
    ...
    lowerActionText:
      "Vigilance mode required. Attach a MARKED token to an enemy model (base_to_bae) with an Unbroken. Once a MARKED model suffers any Wounds, it suffers 1 additional Wound. Remove the token afterwards. ",
    squad: "UNBROKEN",
    count: 0,
    faction: "dvergar",
  },
